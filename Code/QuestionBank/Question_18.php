...
<div class="questionDiv">
    ...
    <hr />
    <p >
        Given an array <i>S</i> of <i>n</i> integers, are there elements <i>a</i>, <i>b</i>, <i>c</i>, and <i>d</i> in <i>S</i> such that <i>a</i> + <i>b</i> + <i>c</i> + <i>d</i> = target? Find all unique quadruplets in the array which gives the sum of target.

        <b>Note:</b> The solution set must not contain duplicate quadruplets.
    </p>
    <b>Example:</b>
    <p class="example">
